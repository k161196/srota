        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Toggle("Agent", isOn: $draft.isAgent)
                        .toggleStyle(.switch)
                        .font(.system(size: 13, weight: .medium))
                        .foregroundStyle(Color.stLabel)
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Commands")
                            ...
                            .foregroundStyle(Color.stMuted)
                        Text(draft.isAgent
                             ? "One command per row. Last row launches the agent (e.g. claude, codex-work)."
                    ...
                    if draft.isAgent {
                        VStack(alignment: .leading, spacing: 6) {
                            Text("Arguments")
                                .font(.system(size: 12, weight: .medium))
                                .foregroundStyle(Color.stMuted)
                            Text("Appended to the launch command, e.g. --dangerously-skip-permissions.")
                                .font(.system(size: 11))
                                .foregroundStyle(Color.stMuted.opacity(0.7))
                            TextField("--dangerously-skip-permissions", text: $draft.arguments)
                                .textFieldStyle(.plain)
                                .font(.system(size: 13, design: .monospaced))
                                .foregroundStyle(Color.stLabel)
                                .padding(10)
